...
#define STRING_CONFIG_H_AUTHOR "(lf, Pegasus)" // Who made the changes.
...
#define MACHINE_UUID "78025d81-5990-42e6-a44f-7755b1bff14c"
...
#define PID_AUTOTUNE_MENU // Add PID Autotune to the LCD "Temperature" menu to run M303 and apply the result.
  ...
  // MakerFarm Pegasus 10 inch w/ E3D-V6
  #define  DEFAULT_Kp 21.16
  #define  DEFAULT_Ki 1.50
  #define  DEFAULT_Kd 74.55
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.19, 80.19, 800, 418.5 }
